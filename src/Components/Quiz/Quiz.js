            ...
            <div >
               {questions.map(question=>               
                    <div className="card  bg-black shadow-xl my-10 p-8 mx-40">
                        ...
                        <svg onClick={()=>displayAnswer()} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
